...
sudo echo "LD_LIBRARY_PATH=/opt/kaltura/ffmpeg-2.1.3/lib
LIBRARY_PATH=/opt/kaltura/ffmpeg-2.1.3/lib
C_INCLUDE_PATH=/opt/kaltura/ffmpeg-2.1.3/include
export LD_LIBRARY_PATH LIBRARY_PATH C_INCLUDE_PATH" >/etc/profile.d/nginx_build.sh
. /etc/profile.d/nginx_build.sh
